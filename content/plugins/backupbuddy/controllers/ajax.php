...
class pb_backupbuddy_ajax extends pb_backupbuddy_ajaxcore {
	...
	public function importexport_settings() {
		...
		echo '<textarea style="width: 100%; height: 120px;" wrap="on">';
		...
		echo 'Paste encoded plugin settings below to import & replace current settings.<br><br>';
		echo '<form method="post" action="' . pb_backupbuddy::ajax_url( 'importexport_settings' ) . '">';
		echo '<textarea style="width: 100%; height: 120px;" wrap="on" name="import_data"></textarea>';
