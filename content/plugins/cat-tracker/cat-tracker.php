...
class Cat_Tracker {
	...
	public function custom_fields() {
		...
		x_add_metadata_field( Cat_Tracker::META_PREFIX . 'num_of_cats', array( Cat_Tracker::MARKER_POST_TYPE ), array( 'field_type' => 'number', 'group' => 'marker_information', 'label' => 'Number of cats', 'min' => 1, 'max' => 500, 'default_value' => 1 ) );
