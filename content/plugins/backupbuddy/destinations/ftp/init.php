		...
		foreach( $files as $file ) {
			...
			if ( $upload === false ) {
				...
				if ( $limit > 0 ) {
					...
					$results = arsort( $backups ); // some ftp servers seem to not report in proper order so reversing insufficiently reliable. need to reverse sort by filename. array_reverse( (array)$backups );
